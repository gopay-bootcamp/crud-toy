...
func TestCreateProc(t *testing.T) {
	...
	id, err := testExec.CreateProc(context.Background(), &proc)
...
func TestReadAllProcs(t *testing.T) {
	...
	result, err := testExec.ReadAllProc(context.Background())
	if err != nil {
		assert.Error(t, err)
	}
	mockClient.AssertExpectations(t)
...
func TestReadProcByID(t *testing.T) {
	...
	result, err := testExec.ReadProcByID(context.Background(), &model.Proc{ID: "1"})
	if err != nil {
		assert.Error(t, err)
	}
	mockClient.AssertExpectations(t)
...
func TestUpdateProc(t *testing.T) {
	...
	_, err := testExec.UpdateProc(context.Background(), &proc)
	if err != nil {
		assert.Error(t, err)
	}
	mockClient.AssertExpectations(t)
...
func TestDeleteProc(t *testing.T) {
	...
	err := testExec.DeleteProc(context.Background(), &model.Proc{ID: "1"})
	mockClient.AssertExpectations(t)
	//data assertions
